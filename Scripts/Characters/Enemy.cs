...
public partial class Enemy : CharacterBody3D, IResponseToInputAction
{
    [Export]
    float WalkSpeed = 2;
    [Export]
    ...
    [Export]
    Array<PackedScene> DefaultEquipments;
    ...
    public void Die()
    {
        ...
        foreach (var kvpair in EquipedEquipments)
        {
            kvpair.Value?.Unequip();
        }
